...
if((strpos($_SERVER["HTTP_HOST"],"admin.webiblos")===0) and ($_SESSION['amin']!="admin") and !(strpos($_SERVER["HTTP_REFERER"],"/adminLogin.php"))){	
	?>
	<script>
...
?>
	<script>
		location.href = "http://www.webiblos.kr";
	</script>
<?
	exit();
}
...
<html>
<head>
<title>Webiblos</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta http-equiv="X-UA-Compatible" content="IE=edge" />

<link rel='stylesheet' type='text/css' href='/css/common.css' />
<link rel='stylesheet' type='text/css' href='/css/select.css' />
<link rel='stylesheet' type='text/css' href='/css/misung.css' />
